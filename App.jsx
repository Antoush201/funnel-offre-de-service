...
const s = {
  ...
  heroH: { fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 'clamp(3rem, 8vw, 5.8rem)', fontWeight: 800, lineHeight: 0.95, letterSpacing: '-0.05em', marginBottom: 28, maxWidth: 700 },
  heroMuted: { color: 'var(--g400)', fontWeight: 300 },
  heroSub: { fontSize: '1.05rem', color: 'var(--g600)', lineHeight: 1.65, maxWidth: 480, marginBottom: 48 },
  heroCta: { display: 'flex', alignItems: 'center', gap: 16, flexWrap: 'wrap', marginBottom: 80 },
  ...
  videoWrap: { position: 'relative', borderRadius: 16, overflow: 'hidden', background: '#0d0d0d', aspectRatio: '16/9', cursor: 'pointer', marginBottom: 100 },
  ...
  bottomCta: { textAlign: 'center', padding: '80px 0 40px', borderTop: '1px solid var(--g200)' },
  bottomCtaH: { fontFamily: "'Bricolage Grotesque', sans-serif", fontSize: 'clamp(1.8rem, 4vw, 2.8rem)', fontWeight: 800, letterSpacing: '-0.04em', marginBottom: 16 },
  bottomCtaSub: { fontSize: '0.9rem', color: 'var(--g600)', marginBottom: 32 },
  ...
  return (
    <div className="fade-up">
      ...
      <div style={s.bottomCta}>
        <div style={s.bottomCtaH}>Prêt à voir quel forfait<br />vous correspond?</div>
        <p style={s.bottomCtaSub}>5 questions · 60 secondes · Résultat immédiat</p>
        <button style={{ ...s.btnBlack, margin: '0 auto', fontSize: '0.95rem', padding: '16px 32px' }} onClick={onStart}>
